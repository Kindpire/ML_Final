...
# mostly come from https://github.com/dennybritz/cnn-text-classification-tf
...
x_train, x_dev = x_shuffled[:-round(len(x_shuffled)*dev_ratio)], x_shuffled[-round(len(x_shuffled)*dev_ratio):]

y_train, y_dev = y_shuffled[:-round(len(x_shuffled)*dev_ratio)], y_shuffled[-round(len(x_shuffled)*dev_ratio):]
